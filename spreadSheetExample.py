...
class Spreadsheet(Frame):
    ...
    def __init__(self, parent, **keywords):
        ...
        self.spreadsheet=Canvas(self, bg='white', bd=0, highlightthickness=0, font=("Purisa",55), **keywords)
    ...
    def redrawHeader(self):
        ...
        for col in self.columns:
            ...
            self.header.create_text(x+width/2, 1, text=col['label'], anchor=N, tags=('title', str(count)))
